    ...
    useEffect(() => {
        ...
        const resizeCanvas = () => {
            if (canvas) {
                ...
                if (ctx) {
                    // Set canvas to fill the full window
        ...
        resizeCanvas(); // Initialize canvas size on first load
        ...
        return () => {
            ...
            window.removeEventListener('resize', resizeCanvas); // Cleanup resize event listener
        };
